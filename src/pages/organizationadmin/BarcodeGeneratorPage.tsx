          ...
          <Card>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/20 bg-white/30 backdrop-blur-sm text-left">
                      ...
                      return (
                        <tr
                          ...
                          className={`border-b cursor-pointer transition-colors ${
                            sel ? 'bg-orange-50/60 hover:bg-orange-100/60' : 'hover:bg-white/30'
                          }`}
                        >
            ...
            <div className="flex flex-wrap justify-between items-center gap-2 p-3 border-t">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="text-xs border border-gray-300 rounded px-1.5 py-1 bg-white focus:outline-none focus:ring-1 focus:ring-orange-500"
                >
                    ...
                    <div key={product.id} className="flex items-center gap-3 px-4 py-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <input
                          ...
                          className="w-12 text-center text-sm font-medium border border-gray-300 rounded px-1 py-0.5 focus:outline-none focus:ring-1 focus:ring-orange-500"
                        />
                        <Button
                          variant="outline"
                          size="sm"
        ...
        <div className="space-y-4">
                ...
                <button
                  ...
                  className={`flex items-center gap-3 p-2 rounded border text-left transition-colors ${
                    options.labelMode === mode.value
                      ...
                      : 'border-white/40 hover:border-white/60 text-gray-700'
                  }`}
                >
                  <span className={options.labelMode === mode.value ? 'text-orange-600' : 'text-gray-500'}>
                    {mode.icon}
                  </span>
                  <div>
                  ...
                  {SIZE_PRESETS.map((preset, idx) => (
                    <button
                      ...
                      className={`w-full text-left text-xs px-2 py-1.5 rounded border transition-colors ${
                        activePreset === idx
                          ? 'border-orange-500 bg-orange-50 text-orange-700'
                          : 'border-white/40 hover:border-white/60 text-gray-600'
                      }`}
                    >
                      {preset.label}
                    </button>
              ...
              {(options.labelMode === 'label-with-barcode' ||
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-xs border border-gray-300 rounded px-2 py-1.5 bg-white focus:outline-none focus:ring-1 focus:ring-orange-500"
                  >
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="flex-1 bg-orange-600 hover:bg-orange-700 text-white gap-2 py-3 text-sm"
            >
              {generating ? (
            ...
            <Button
              ...
              disabled={generating || printing || noGapGenerating || selected.length === 0}
              variant="outline"
              className="flex-1 border-orange-500 text-orange-600 hover:bg-orange-50 gap-2 py-3 text-sm"
            >
              {printing ? (
                <RefreshCw className="w-4 h-4 animate-spin" />
              ) : (
